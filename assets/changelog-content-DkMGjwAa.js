...
`)):(h.inline=!0,b=i.replace(Q,""));const y=g(b,h);return h.inline=k,h.list=v,y}),ordered:t,start:w}},render:(p,g,h)=>a(p.ordered?"ol":"ul",{key:h.key,start:p.type===l.orderedList?p.start:void 0},p.items.map(function(w,C){return a("li",{key:C},g(w,h))}))}}const vn=new RegExp(`^\\[((?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*)\\]\\(\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*\\)`),wn=/^!\[(.*?)\]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,ke=[ee,ne,te,re,ae,oe,ie,le,he,fe,me,ye],An=[...ke,/^[^\n]+(?:  \n|\n{2,})/,j,D];function R(a){return a.replace(/[ÀÁÂÃÄÅàáâãäåæÆ]/g,"a").replace(/[çÇ]/g,"c").replace(/[ðÐ]/g,"d").replace(/[ÈÉÊËéèêë]/g,"e").replace(/[ÏïÎîÍíÌì]/g,"i").replace(/[Ññ]/g,"n").replace(/[øØœŒÕõÔôÓóÒò]/g,"o").replace(/[ÜüÛûÚúÙù]/g,"u").replace(/[ŸÿÝý]/g,"y").replace(/[^a-z0-9- ]/gi,"").replace(/ /gi,"-").toLowerCase()}function Cn(a){return sn.test(a)?"right":an.test(a)?"center":ln.test(a)?"left":null}function J(a,o,t,u){const c=t.inTable;t.inTable=!0;let f=[[]],p="";function g(){if(!p)return;const h=f[f.length-1];h.push.apply(h,o(p,t)),p=""}return a.trim().split(/(`[^`]*`|\\\||\|)/).filter(Boolean).forEach((h,w,C)=>{h.trim()==="|"&&(g(),u)?w!==0&&w!==C.length-1&&f.push([]):p+=h}),g(),t.inTable=c,f}function Sn(a,o,t){t.inline=!0;const u=a[2]?a[2].replace(on,"").split("|").map(Cn):[],c=a[3]?function(p,g,h){return p.trim().split(`
`).map(function(w){return J(w,g,h,!0)})}(a[3],o,t):[],f=J(a[1],o,t,!!c.length);return t.inline=!1,c.length?{align:u,cells:c,header:f,type:l.table}:{children:f,type:l.paragraph}}function K(a,o){return a.align[o]==null?{}:{textAlign:a.align[o]}}function I(a){return function(o,t){return t.inline?a.exec(o):null}}function E(a){return function(o,t){return t.inline||t.simple?a.exec(o):null}}function S(a){return function(o,t){return t.inline||t.simple?null:a.exec(o)}}function z(a){return function(o){return a.exec(o)}}function In(a,o){if(o.inline||o.simple)return null;let t="";a.split(`
`).every(c=>(c+=`
`,!ke.some(f=>f.test(c))&&(t+=c,!!c.trim())));const u=t.trimEnd();return u==""?null:[t,u]}function En(a){try{if(decodeURIComponent(a).replace(/[^A-Za-z0-9/:]/g,"").match(/^\s*(javascript|vbscript|data(?!:image)):/i))return null}catch{return null}return a}function Y(a){return a.replace(yn,"$1")}function M(a,o,t){const u=t.inline||!1,c=t.simple||!1;t.inline=!0,t.simple=!0;const f=a(o,t);return t.inline=u,t.simple=c,f}function $n(a,o,t){const u=t.inline||!1,c=t.simple||!1;t.inline=!1,t.simple=!0;const f=a(o,t);return t.inline=u,t.simple=c,f}function Ln(a,o,t){const u=t.inline||!1;t.inline=!1;const c=a(o,t);return t.inline=u,c}const F=(a,o,t)=>({children:M(o,a[1],t)});function B(){return{}}function P(){return null}function Rn(...a){return a.filter(Boolean).join(" ")}function U(a,o,t){let u=a;const c=o.split(".");for(;c.length&&(u=u[c[0]],u!==void 0);)c.shift();return u||t}function zn(a="",o={}){function t(e,r,...n){const s=U(o.overrides,`${e}.props`,{});return o.createElement(function(i,d){const m=U(d,i);return m?typeof m=="function"||typeof m=="object"&&"render"in m?m:U(d,`${i}.component`,i):i}(e,o.overrides),$({},r,s,{className:Rn(r==null?void 0:r.className,s.className)||void 0}),...n)}function u(e){e=e.replace(_e,"");let r=!1;o.forceInline?r=!0:o.forceBlock||(r=tn.test(e)===!1);const n=w(h(r?e:`${e.trimEnd().replace(gn,"")}

`,{inline:r}));for(;typeof n[n.length-1]=="string"&&!n[n.length-1].trim();)n.pop();if(o.wrapper===null)return n;const s=o.wrapper||(r?"span":"div");let i;if(n.length>1||o.forceWrapper)i=n;else{if(n.length===1)return i=n[0],typeof i=="string"?t("span",{key:"outer"},i):i;i=null}return o.createElement(s,{key:"outer"},i)}function c(e,r){const n=r.match(ze);return n?n.reduce(function(s,i){const d=i.indexOf("=");if(d!==-1){const m=function(y){return y.indexOf("-")!==-1&&y.match(qe)===null&&(y=y.replace(Ke,function(x,A){return A.toUpperCase()})),y}(i.slice(0,d)).trim(),k=function(y){const x=y[0];return(x==='"'||x==="'")&&y.length>=2&&y[y.length-1]===x?y.slice(1,-1):y}(i.slice(d+1).trim()),v=q[m]||m;if(v==="ref")return s;const b=s[v]=function(y,x,A,xe){return x==="style"?A.split(/;\s?/).reduce(function(_,O){const G=O.slice(0,O.indexOf(":"));return _[G.trim().replace(/(-[a-z])/g,be=>be[1].toUpperCase())]=O.slice(G.length+1).trim(),_},{}):x==="href"||x==="src"?xe(A,y,x):(A.match(Ve)&&(A=A.slice(1,A.length-1)),A==="true"||A!=="false"&&A)}(e,m,k,o.sanitizer);typeof b=="string"&&(j.test(b)||D.test(b))&&(s[v]=u(b.trim()))}else i!=="style"&&(s[q[i]||i]=!0);return s},{}):null}o.overrides=o.overrides||{},o.sanitizer=o.sanitizer||En,o.slugify=o.slugify||R,o.namedCodesToUnicode=o.namedCodesToUnicode?$({},V,o.namedCodesToUnicode):V,o.createElement=o.createElement||H.createElement;const f=[],p={},g={[l.blockQuote]:{match:S(ee),order:1,parse(e,r,n){const[,s,i]=e[0].replace(Oe,"").match(Fe);return{alert:s,children:r(i,n)}},render(e,r,n){const s={key:n.key};return e.alert&&(s.className="markdown-alert-"+o.slugify(e.alert.toLowerCase(),R),e.children.unshift({attrs:{},children:[{type:l.text,text:e.alert}],noInnerParse:!0,type:l.htmlBlock,tag:"header"})),t("blockquote",s,r(e.children,n))}},[l.breakLine]:{match:z(Be),order:1,parse:B,render:(e,r,n)=>t("br",{key:n.key})},[l.breakThematic]:{match:S(Pe),order:1,parse:B,render:(e,r,n)=>t("hr",{key:n.key})},[l.codeBlock]:{match:S(te),order:0,parse:e=>({lang:void 0,text:e[0].replace(/^ {4}/gm,"").replace(/\n+$/,"")}),render:(e,r,n)=>t("pre",{key:n.key},t("code",$({},e.attrs,{className:e.lang?`lang-${e.lang}`:""}),e.text))},[l.codeFenced]:{match:S(ne),order:0,parse:e=>({attrs:c("code",e[3]||""),lang:e[2]||void 0,text:e[4],type:l.codeBlock})},[l.codeInline]:{match:E(Ue),order:3,parse:e=>({text:e[2]}),render:(e,r,n)=>t("code",{key:n.key},e.text)},[l.footnote]:{match:S(He),order:0,parse:e=>(f.push({footnote:e[2],identifier:e[1]}),{}),render:P},[l.footnoteReference]:{match:I(We),order:1,parse:e=>({target:`#${o.slugify(e[1],R)}`,text:e[1]}),render:(e,r,n)=>t("a",{key:n.key,href:o.sanitizer(e.target,"a","href")},t("sup",{key:n.key},e.text))},[l.gfmTask]:{match:I(Ge),order:1,parse:e=>({completed:e[1].toLowerCase()==="x"}),render:(e,r,n)=>t("input",{checked:e.completed,key:n.key,readOnly:!0,type:"checkbox"})},[l.heading]:{match:S(o.enforceAtxHeadings?oe:re),order:1,parse:(e,r,n)=>({children:M(r,e[2],n),id:o.slugify(e[2],R),level:e[1].length}),render:(e,r,n)=>t(`h${e.level}`,{id:e.id,key:n.key},r(e.children,n))},[l.headingSetext]:{match:S(ae),order:0,parse:(e,r,n)=>({children:M(r,e[1],n),level:e[2]==="="?1:2,type:l.heading})},[l.htmlBlock]:{match:z(j),order:1,parse(e,r,n){const[,s]=e[3].match(fn),i=new RegExp(`^${s}`,"gm"),d=e[3].replace(i,""),m=(k=d,An.some(A=>A.test(k))?Ln:M);var k;const v=e[1].toLowerCase(),b=Re.indexOf(v)!==-1,y=(b?v:e[1]).trim(),x={attrs:c(y,e[2]),noInnerParse:b,tag:y};return n.inAnchor=n.inAnchor||v==="a",b?x.text=e[3]:x.children=m(r,d,n),n.inAnchor=!1,x},render:(e,r,n)=>t(e.tag,$({key:n.key},e.attrs),e.text||(e.children?r(e.children,n):""))},[l.htmlSelfClosing]:{match:z(D),order:1,parse(e){const r=e[1].trim();return{attrs:c(r,e[2]||""),tag:r}},render:(e,r,n)=>t(e.tag,$({},e.attrs,{key:n.key}))},[l.htmlComment]:{match:z(ie),order:1,parse:()=>({}),render:P},[l.image]:{match:E(wn),order:1,parse:e=>({alt:e[1],target:Y(e[2]),title:e[3]}),render:(e,r,n)=>t("img",{key:n.key,alt:e.alt||void 0,title:e.title||void 0,src:o.sanitizer(e.target,"img","src")})},[l.link]:{match:I(vn),order:3,parse:(e,r,n)=>({children:$n(r,e[1],n),target:Y(e[2]),title:e[3]}),render:(e,r,n)=>t("a",{key:n.key,href:o.sanitizer(e.target,"a","href"),title:e.title},r(e.children,n))},[l.linkAngleBraceStyleDetector]:{match:I(Je),order:0,parse:e=>({children:[{text:e[1],type:l.text}],target:e[1],type:l.link})},[l.linkBareUrlDetector]:{match:(e,r)=>r.inAnchor||o.disableAutoLink?null:I(Qe)(e,r),order:0,parse:e=>({children:[{text:e[1],type:l.text}],target:e[1],title:void 0,type:l.link})},[l.linkMailtoDetector]:{match:I(Xe),order:0,parse(e){let r=e[1],n=e[1];return Me.test(n)||(n="mailto:"+n),{children:[{text:r.replace("mailto:",""),type:l.text}],target:n,type:l.link}}},[l.orderedList]:X(t,1),[l.unorderedList]:X(t,2),[l.newlineCoalescer]:{match:S(je),order:3,parse:B,render:()=>`
`},[l.paragraph]:{match:In,order:3,parse:F,render:(e,r,n)=>t("p",{key:n.key},r(e.children,n))},[l.ref]:{match:I(Ye),order:0,parse:e=>(p[e[1]]={target:e[2],title:e[4]},{}),render:P},[l.refImage]:{match:E(en),order:0,parse:e=>({alt:e[1]||void 0,ref:e[2]}),render:(e,r,n)=>p[e.ref]?t("img",{key:n.key,alt:e.alt,src:o.sanitizer(p[e.ref].target,"img","src"),title:p[e.ref].title}):null},[l.refLink]:{match:I(nn),order:0,parse:(e,r,n)=>({children:r(e[1],n),fallbackChildren:e[0],ref:e[2]}),render:(e,r,n)=>p[e.ref]?t("a",{key:n.key,href:o.sanitizer(p[e.ref].target,"a","href"),title:p[e.ref].title},r(e.children,n)):t("span",{key:n.key},e.fallbackChildren)},[l.table]:{match:S(le),order:1,parse:Sn,render(e,r,n){const s=e;return t("table",{key:n.key},t("thead",null,t("tr",null,s.header.map(function(i,d){return t("th",{key:d,style:K(s,d)},r(i,n))}))),t("tbody",null,s.cells.map(function(i,d){return t("tr",{key:d},i.map(function(m,k){return t("td",{key:k,style:K(s,k)},r(m,n))}))})))}},[l.text]:{match:z(mn),order:4,parse:e=>({text:e[0].replace(Ze,(r,n)=>o.namedCodesToUnicode[n]?o.namedCodesToUnicode[n]:r)}),render:e=>e.text},[l.textBolded]:{match:E(cn),order:2,parse:(e,r,n)=>({children:r(e[2],n)}),render:(e,r,n)=>t("strong",{key:n.key},r(e.children,n))},[l.textEmphasized]:{match:E(dn),order:3,parse:(e,r,n)=>({children:r(e[2],n)}),render:(e,r,n)=>t("em",{key:n.key},r(e.children,n))},[l.textEscaped]:{match:E(hn),order:1,parse:e=>({text:e[1],type:l.text})},[l.textMarked]:{match:E(pn),order:3,parse:F,render:(e,r,n)=>t("mark",{key:n.key},r(e.children,n))},[l.textStrikethroughed]:{match:E(un),order:3,parse:F,render:(e,r,n)=>t("del",{key:n.key},r(e.children,n))}};o.disableParsingRawHTML===!0&&(delete g[l.htmlBlock],delete g[l.htmlSelfClosing]);const h=function(e){let r=Object.keys(e);function n(s,i){let d=[];for(i.prevCapture=i.prevCapture||"";s;){let m=0;for(;m<r.length;){const k=r[m],v=e[k],b=v.match(s,i);if(b){const y=b[0];i.prevCapture+=y,s=s.substring(y.length);const x=v.parse(b,n,i);x.type==null&&(x.type=k),d.push(x);break}m++}}return i.prevCapture="",d}return r.sort(function(s,i){let d=e[s].order,m=e[i].order;return d!==m?d-m:s<i?-1:1}),function(s,i){return n(function(d){return d.replace(De,`
`).replace(Ne,"").replace(rn,"    ")}(s),i)}}(g),w=(C=function(e,r){return function(n,s,i){const d=e[n.type].render;return r?r(()=>d(n,s,i),n,s,i):d(n,s,i)}}(g,o.renderRule),function e(r,n={}){if(Array.isArray(r)){const s=n.key,i=[];let d=!1;for(let m=0;m<r.length;m++){n.key=m;const k=e(r[m],n),v=typeof k=="string";v&&d?i[i.length-1]+=k:k!==null&&i.push(k),d=v}return n.key=s,i}return C(r,e,n)});var C;const L=u(a);return f.length?t("div",null,L,t("footer",{key:"footer"},f.map(function(e){return t("div",{id:o.slugify(e.identifier,R),key:e.identifier},e.identifier,w(h(e.footnote,{inline:!0})))}))):L}const Mn=a=>{let{children:o="",options:t}=a,u=function(c,f){if(c==null)return{};var p,g,h={},w=Object.keys(c);for(g=0;g<w.length;g++)f.indexOf(p=w[g])>=0||(h[p]=c[p]);return h}(a,Le);return H.cloneElement(zn(o,t),u)};function On(){return ve(we.Changelog),H.useEffect(Ae,[]),Ce.jsx(Mn,{options:{overrides:{h1:{component:"h1",props:{hidden:!0}},h2:{component:Se,props:{size:"md",mt:2}},p:{component:Ie},ul:{component:Ee},li:{component:$e}}},children:`# My Racing Planner Change Log
