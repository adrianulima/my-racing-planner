...
function SeasonSettingsPopover() {
  ...
  const settingsList = [
    ...
    {
      id: "emptyWeeks",
      text: t("settings.hideEmptyWeeks"),
      tooltip: t("settings.hideEmptyWeeksTooltip"),
      checked: seasonHideEmptyWeeks,
      setChecked: setSeasonHideEmptyWeeks,
    },
    {
      id: "pastWeeks",
